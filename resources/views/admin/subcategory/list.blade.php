          ...
          <div class="page-body">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ url('adminpanel/subcategory/add') }}">
                 <button type="button" class="btn waves-effect waves-light hor-grd btn-grd-primary pull-right">Add Sub Category</button> 
                </a>
                  ...
                  <table id="dom-jqry-hh" class="table table-striped table-bordered nowrap">
                    ...
                    @php
                      ...
                      <tr>
                        ...
                        <td align="center"><a href="{{ url('adminpanel/subcategory/edit/'.$id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        &nbsp;&nbsp;
