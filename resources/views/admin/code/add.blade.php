                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Add Code Details</h5>
                                        <a href="{{ url('adminpanel/code/list') }}">
                                            <button type="button"
                                                class="btn waves-effect waves-light hor-grd btn-grd-primary pull-right">Back</button>
                                        </a>
                                    </div>
                                    <div class="card-block">
                                        ...
                                        <form method="post" action="" autocomplete="off" enctype="multipart/form-data"
                                            novalidate="novalidate" id="NewForm">
                                            @csrf

                                            <img src="" alt="" class="" id="output">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="language"
                                                        placeholder="Please Enter Language*" value="{{ old('language') }}"
                                                        class="form-control" />
                                                    <span class="text-danger">
                                                        @error('language')
                                                            {{ $message }}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea placeholder="Please Enter Title*" name="title" class="form-control">{{ old('title') }}</textarea>
                                                    <span class="text-danger">
                                                        @error('title')
                                                            {{ $message }}
                                                        @enderror
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="description" class="form-control" id="editor14" rows="20" placeholder="Please Enter Description*">{{ old('description') }}</textarea>
                                                    <span class="text-danger">
                                                        @error('description')
                                                            {{ $message }}
                                                        @enderror
                                            ...
                                            <div class="col-sm-12 col-md-12 col-xs-12">
                                                <div class="form-group">
                                                    <a href="{{ url('adminpanel/code/list') }}"
                                                        class="btn waves-effect waves-light hor-grd btn-grd-danger text-white">Go
                                                        Back</a>
                                                    &nbsp;&nbsp;

                                                    <input type="submit"
                                                        class="btn waves-effect waves-light hor-grd btn-grd-success submitb"
                                                        value="Submit">
                                                </div>
                                            </div>
