...
<script type="text/javascript" src="{{asset('/admin_assets')}}/bower_components/modernizr/js/css-scrollbars.js"></script>
<!-- waves js -->
<script src="{{asset('/admin_assets')}}/assets/pages/waves/js/waves.min.js"></script>
<!-- data-table js -->
...
<script type="text/javascript" src="{{asset('/admin_assets')}}/assets/js/toastr.js"></script>
<script type="text/javascript" src="{{asset('/admin_assets')}}/assets/js/validate.js"></script>

<script type="text/javascript" src="{{asset('/admin_assets')}}/assets/js/prism.js"></script>
